...
def render_appointments_tab():
    ...
    with st.form(key="appointment_form"):
        ...
        reason = st.text_area(
            "Reason / Notes",
            placeholder="Example: Follow-up for chronic kidney disease, recent lab results available.",
        )
    ...
    if st.button("🧹 Clear All Appointments"):
        st.session_state.appointment_db = []
        st.success("All appointments have been cleared.")
        st.experimental_rerun()

    # If none exist, show message
